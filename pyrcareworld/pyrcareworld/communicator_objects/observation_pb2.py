...
# source: pyrcareworld/communicator_objects/observation.proto
...
_COMPRESSIONTYPEPROTO = _descriptor.EnumDescriptor(
    ...
    values=[
        ...
        _descriptor.EnumValueDescriptor(
            name="PNG", index=1, number=1, options=None, type=None
        ),
    ],
...
_OBSERVATIONTYPEPROTO = _descriptor.EnumDescriptor(
    ...
    values=[
        ...
        _descriptor.EnumValueDescriptor(
            name="GOAL_SIGNAL", index=1, number=1, options=None, type=None
        ),
    ],
    containing_type=None,
    options=None,
...
_OBSERVATIONPROTO_FLOATDATA = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="data",
            full_name="communicator_objects.ObservationProto.FloatData.data",
            index=0,
            number=1,
            type=2,
            cpp_type=6,
...
_OBSERVATIONPROTO = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="shape",
            full_name="communicator_objects.ObservationProto.shape",
            index=0,
            number=1,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="communicator_objects.ObservationProto.compression_type",
            index=1,
            number=2,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="communicator_objects.ObservationProto.compressed_data",
            index=2,
            number=3,
            type=12,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="float_data",
            full_name="communicator_objects.ObservationProto.float_data",
            index=3,
            number=4,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="compressed_channel_mapping",
            full_name="communicator_objects.ObservationProto.compressed_channel_mapping",
            index=4,
            number=5,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="communicator_objects.ObservationProto.dimension_properties",
            index=5,
            number=6,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="communicator_objects.ObservationProto.observation_type",
            index=6,
            number=7,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name="name",
            full_name="communicator_objects.ObservationProto.name",
            index=7,
            number=8,
            type=9,
            cpp_type=9,
    ...
    oneofs=[
        _descriptor.OneofDescriptor(
            ...
            full_name="communicator_objects.ObservationProto.observation_data",
            index=0,
            containing_type=None,
            fields=[],
        ),
...
ObservationProto = _reflection.GeneratedProtocolMessageType(
    "ObservationProto",
    (_message.Message,),
    dict(
        FloatData=_reflection.GeneratedProtocolMessageType(
            "FloatData",
            (_message.Message,),
            dict(
