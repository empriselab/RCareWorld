...
# source: pyrcareworld/communicator_objects/unity_rl_input.proto
...
from pyrcareworld.communicator_objects import (
    command_pb2 as pyrcareworld_dot_communicator__objects_dot_command__pb2,
)


DESCRIPTOR = _descriptor.FileDescriptor(
    name="pyrcareworld/communicator_objects/unity_rl_input.proto",
    package="communicator_objects",
    syntax="proto3",
    serialized_pb=_b(
        '\n6pyrcareworld/communicator_objects/unity_rl_input.proto\x12\x14\x63ommunicator_objects\x1a\x34pyrcareworld/communicator_objects/agent_action.proto\x1a/pyrcareworld/communicator_objects/command.proto"\xfe\x02\n\x11UnityRLInputProto\x12P\n\ragent_actions\x18\x01 \x03(\x0b\x32\x39.communicator_objects.UnityRLInputProto.AgentActionsEntry\x12\x33\n\x07\x63ommand\x18\x04 \x01(\x0e\x32".communicator_objects.CommandProto\x12\x14\n\x0cside_channel\x18\x05 \x01(\x0c\x1aM\n\x14ListAgentActionProto\x12\x35\n\x05value\x18\x01 \x03(\x0b\x32&.communicator_objects.AgentActionProto\x1aq\n\x11\x41gentActionsEntry\x12\x0b\n\x03key\x18\x01 \x01(\t\x12K\n\x05value\x18\x02 \x01(\x0b\x32<.communicator_objects.UnityRLInputProto.ListAgentActionProto:\x02\x38\x01J\x04\x08\x02\x10\x03J\x04\x08\x03\x10\x04\x42+\xaa\x02(Robotflow.RFUniverse.CommunicatorObjectsb\x06proto3'
    ),
    dependencies=[
        pyrcareworld_dot_communicator__objects_dot_agent__action__pb2.DESCRIPTOR,
        pyrcareworld_dot_communicator__objects_dot_command__pb2.DESCRIPTOR,
    ],
)
...
_UNITYRLINPUTPROTO_LISTAGENTACTIONPROTO = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="value",
            full_name="communicator_objects.UnityRLInputProto.ListAgentActionProto.value",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_UNITYRLINPUTPROTO_AGENTACTIONSENTRY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="key",
            full_name="communicator_objects.UnityRLInputProto.AgentActionsEntry.key",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="value",
            full_name="communicator_objects.UnityRLInputProto.AgentActionsEntry.value",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_UNITYRLINPUTPROTO = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="agent_actions",
            full_name="communicator_objects.UnityRLInputProto.agent_actions",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="command",
            full_name="communicator_objects.UnityRLInputProto.command",
            index=1,
            number=4,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name="side_channel",
            full_name="communicator_objects.UnityRLInputProto.side_channel",
            index=2,
            number=5,
            type=12,
            cpp_type=9,
    ...
    extensions=[],
    nested_types=[
        _UNITYRLINPUTPROTO_LISTAGENTACTIONPROTO,
...
_UNITYRLINPUTPROTO_LISTAGENTACTIONPROTO.fields_by_name["value"].message_type = (
...
_UNITYRLINPUTPROTO_AGENTACTIONSENTRY.fields_by_name["value"].message_type = (
    _UNITYRLINPUTPROTO_LISTAGENTACTIONPROTO
)
_UNITYRLINPUTPROTO_AGENTACTIONSENTRY.containing_type = _UNITYRLINPUTPROTO
_UNITYRLINPUTPROTO.fields_by_name["agent_actions"].message_type = (
    _UNITYRLINPUTPROTO_AGENTACTIONSENTRY
)
_UNITYRLINPUTPROTO.fields_by_name["command"].enum_type = (
    pyrcareworld_dot_communicator__objects_dot_command__pb2._COMMANDPROTO
)
DESCRIPTOR.message_types_by_name["UnityRLInputProto"] = _UNITYRLINPUTPROTO
_sym_db.RegisterFileDescriptor(DESCRIPTOR)

UnityRLInputProto = _reflection.GeneratedProtocolMessageType(
    "UnityRLInputProto",
    (_message.Message,),
    dict(
        ListAgentActionProto=_reflection.GeneratedProtocolMessageType(
            ...
            dict(
                ...
                __module__="pyrcareworld.communicator_objects.unity_rl_input_pb2",
...
_UNITYRLINPUTPROTO_AGENTACTIONSENTRY._options = _descriptor._ParseOptions(
