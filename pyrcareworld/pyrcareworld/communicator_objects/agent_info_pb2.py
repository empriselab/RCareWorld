...
# source: pyrcareworld/communicator_objects/agent_info.proto
...
from pyrcareworld.communicator_objects import (
    observation_pb2 as pyrcareworld_dot_communicator__objects_dot_observation__pb2,
)


DESCRIPTOR = _descriptor.FileDescriptor(
    name="pyrcareworld/communicator_objects/agent_info.proto",
    package="communicator_objects",
    syntax="proto3",
    serialized_pb=_b(
        '\n2pyrcareworld/communicator_objects/agent_info.proto\x12\x14\x63ommunicator_objects\x1a\x33pyrcareworld/communicator_objects/observation.proto"\xf9\x01\n\x0e\x41gentInfoProto\x12\x0e\n\x06reward\x18\x07 \x01(\x02\x12\x0c\n\x04\x64one\x18\x08 \x01(\x08\x12\x18\n\x10max_step_reached\x18\t \x01(\x08\x12\n\n\x02id\x18\n \x01(\x05\x12\x13\n\x0b\x61\x63tion_mask\x18\x0b \x03(\x08\x12<\n\x0cobservations\x18\r \x03(\x0b\x32&.communicator_objects.ObservationProto\x12\x10\n\x08group_id\x18\x0e \x01(\x05\x12\x14\n\x0cgroup_reward\x18\x0f \x01(\x02J\x04\x08\x01\x10\x02J\x04\x08\x02\x10\x03J\x04\x08\x03\x10\x04J\x04\x08\x04\x10\x05J\x04\x08\x05\x10\x06J\x04\x08\x06\x10\x07J\x04\x08\x0c\x10\rB+\xaa\x02(Robotflow.RFUniverse.CommunicatorObjectsb\x06proto3'
    ),
    dependencies=[
        pyrcareworld_dot_communicator__objects_dot_observation__pb2.DESCRIPTOR,
    ],
)
...
_AGENTINFOPROTO = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="observations",
            full_name="communicator_objects.AgentInfoProto.observations",
            index=5,
            number=13,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="group_id",
            full_name="communicator_objects.AgentInfoProto.group_id",
            index=6,
            number=14,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="group_reward",
            full_name="communicator_objects.AgentInfoProto.group_reward",
            index=7,
            number=15,
            type=2,
            cpp_type=6,
