...
# source: pyrcareworld/communicator_objects/unity_rl_output.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
    name="pyrcareworld/communicator_objects/unity_rl_output.proto",
    package="communicator_objects",
    syntax="proto3",
    serialized_pb=_b(
        '\n7pyrcareworld/communicator_objects/unity_rl_output.proto\x12\x14\x63ommunicator_objects\x1a\x32pyrcareworld/communicator_objects/agent_info.proto"\xb9\x02\n\x12UnityRLOutputProto\x12L\n\nagentInfos\x18\x02 \x03(\x0b\x32\x38.communicator_objects.UnityRLOutputProto.AgentInfosEntry\x12\x14\n\x0cside_channel\x18\x03 \x01(\x0c\x1aI\n\x12ListAgentInfoProto\x12\x33\n\x05value\x18\x01 \x03(\x0b\x32$.communicator_objects.AgentInfoProto\x1an\n\x0f\x41gentInfosEntry\x12\x0b\n\x03key\x18\x01 \x01(\t\x12J\n\x05value\x18\x02 \x01(\x0b\x32;.communicator_objects.UnityRLOutputProto.ListAgentInfoProto:\x02\x38\x01J\x04\x08\x01\x10\x02\x42+\xaa\x02(Robotflow.RFUniverse.CommunicatorObjectsb\x06proto3'
    ),
    dependencies=[
...
_UNITYRLOUTPUTPROTO_LISTAGENTINFOPROTO = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="value",
            full_name="communicator_objects.UnityRLOutputProto.ListAgentInfoProto.value",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_UNITYRLOUTPUTPROTO_AGENTINFOSENTRY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="key",
            full_name="communicator_objects.UnityRLOutputProto.AgentInfosEntry.key",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="value",
            full_name="communicator_objects.UnityRLOutputProto.AgentInfosEntry.value",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_UNITYRLOUTPUTPROTO = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="agentInfos",
            full_name="communicator_objects.UnityRLOutputProto.agentInfos",
            index=0,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="side_channel",
            full_name="communicator_objects.UnityRLOutputProto.side_channel",
            index=1,
            number=3,
            type=12,
            cpp_type=9,
...
UnityRLOutputProto = _reflection.GeneratedProtocolMessageType(
    "UnityRLOutputProto",
    (_message.Message,),
    dict(
...
_UNITYRLOUTPUTPROTO_AGENTINFOSENTRY._options = _descriptor._ParseOptions(
