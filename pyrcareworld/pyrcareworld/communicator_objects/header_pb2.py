...
# source: pyrcareworld/communicator_objects/header.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
    name="pyrcareworld/communicator_objects/header.proto",
    package="communicator_objects",
    syntax="proto3",
    serialized_pb=_b(
        '\n.pyrcareworld/communicator_objects/header.proto\x12\x14\x63ommunicator_objects".\n\x0bHeaderProto\x12\x0e\n\x06status\x18\x01 \x01(\x05\x12\x0f\n\x07message\x18\x02 \x01(\tB+\xaa\x02(Robotflow.RFUniverse.CommunicatorObjectsb\x06proto3'
    ),
)
...
_HEADERPROTO = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="status",
            full_name="communicator_objects.HeaderProto.status",
            index=0,
            number=1,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="message",
            full_name="communicator_objects.HeaderProto.message",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
