...
def process_a_link(f, link_name, link_path, xyz, rpy, inertial=None, color=None):
    ...
    if color is None:
        f.write(
            '           <material name=""><color rgba="0.827450980392157 0.83921568627451 0.827450980392157 1" /></material>\n'
        )
    else:
        f.write(
            '           <material name=""><color rgba="{} {} {} 1" /></material>\n'.format(
