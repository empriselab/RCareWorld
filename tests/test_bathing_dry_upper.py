...
for i in range(150):
    ...
    if i % 10 == 0:  # Save every 10 steps
        save_step_data(step_counter, {'phase': 'move_to_shoulder'})
...
for i in range(150):
    ...
    step_counter += 1
    if i % 10 == 0:  # Save every 10 steps
        save_step_data(step_counter, {'phase': 'hop_up_1'})
...
for i in range(150):
    ...
    step_counter += 1
    if i % 10 == 0:  # Save every 10 steps
        save_step_data(step_counter, {'phase': 'hop_down'})
...
for i in range(150):
    ...
    step_counter += 1
    if i % 10 == 0:  # Save every 10 steps
        save_step_data(step_counter, {'phase': 'hop_up_2'})
